...
_DEFAULT_SETTINGS = {
    ...
    "done_instructions": (
        "Payment complete karne ke baad neeche <b>✅ DONE</b> button dabao.\n"
        "Please button sirf payment ho jaane ke baad hi dabaye."
    ),
    "screenshot_prompt": "Payment screenshot yahin bhej do 📸",
...
def find_active_order_for_user(user_id):
    return orders.find_one(
        {"user_id": user_id, "status": {"$in": ["awaiting_payment", "awaiting_screenshot", "pending"]}},
        sort=[("created_at", -1)],
    )
