...
def done_kb(order_id):
    return InlineKeyboardMarkup([[InlineKeyboardButton("✅ DONE", callback_data=f"done:{order_id}")]])
...
def admin_settings_kb():
    rows = [
        ...
        [InlineKeyboardButton("Done-button Instructions Text", callback_data="adm:set:done_instructions")],
        [InlineKeyboardButton("Screenshot Prompt Text", callback_data="adm:set:screenshot_prompt")],
